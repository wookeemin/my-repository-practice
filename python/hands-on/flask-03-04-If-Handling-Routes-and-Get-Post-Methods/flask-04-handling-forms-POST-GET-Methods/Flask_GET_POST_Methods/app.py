...
def calc():
    if request.method == 'POST':
        ...
        return render_template('result.html', lcm=my_lcm, result1=num1, result2=num2, developer_name='WooKee')
    else: # if this is a GET request - user comes directly
        return render_template('result.html', developer_name='WooKee')
